...
class HelloRequest final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_vhivemetadata(ArgT0&& arg0, ArgT... args);
  std::string* mutable_vhivemetadata();
  PROTOBUF_NODISCARD std::string* release_vhivemetadata();
  void set_allocated_vhivemetadata(std::string* vhivemetadata);
  private:
  const std::string& _internal_vhivemetadata() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_vhivemetadata(const std::string& value);
...
inline void HelloRequest::clear_vhivemetadata() {
  _impl_.vhivemetadata_.ClearToEmpty();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HelloRequest::set_vhivemetadata(ArgT0&& arg0, ArgT... args) {
 
 _impl_.vhivemetadata_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* HelloRequest::mutable_vhivemetadata() {
  std::string* _s = _internal_mutable_vhivemetadata();
...
inline const std::string& HelloRequest::_internal_vhivemetadata() const {
  return _impl_.vhivemetadata_.Get();
}
inline void HelloRequest::_internal_set_vhivemetadata(const std::string& value) {
  
  _impl_.vhivemetadata_.Set(value, GetArenaForAllocation());
}
inline std::string* HelloRequest::_internal_mutable_vhivemetadata() {
  
  return _impl_.vhivemetadata_.Mutable(GetArenaForAllocation());
}
inline std::string* HelloRequest::release_vhivemetadata() {
  ...
  return _impl_.vhivemetadata_.Release();
}
inline void HelloRequest::set_allocated_vhivemetadata(std::string* vhivemetadata) {
  ...
  _impl_.vhivemetadata_.SetAllocated(vhivemetadata, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.vhivemetadata_.IsDefault()) {
    _impl_.vhivemetadata_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
