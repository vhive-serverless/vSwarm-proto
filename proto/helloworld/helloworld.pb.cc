...
PROTOBUF_CONSTEXPR HelloRequest::HelloRequest(
  ...
  , /*decltype(_impl_.vhivemetadata_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, _impl_.vhivemetadata_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_helloworld_2eproto = {
    false, false, 258, descriptor_table_protodef_helloworld_2eproto,
    "helloworld.proto",
...
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.vhivemetadata_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _impl_.vhivemetadata_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.vhivemetadata_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_vhivemetadata().empty()) {
    _this->_impl_.vhivemetadata_.Set(from._internal_vhivemetadata(), 
      _this->GetArenaForAllocation());
  }
...
uint8_t* HelloRequest::_InternalSerialize(
  ...
  // bytes vHiveMetadata = 15;
  if (!this->_internal_vhivemetadata().empty()) {
...
void HelloRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_vhivemetadata().empty()) {
    _this->_internal_set_vhivemetadata(from._internal_vhivemetadata());
  }
...
void HelloRequest::InternalSwap(HelloRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.vhivemetadata_, lhs_arena,
      &other->_impl_.vhivemetadata_, rhs_arena
  );
}
