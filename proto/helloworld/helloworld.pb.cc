...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, vhivemetadata_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_helloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "equest\022\014\n\004name\030\001 \001(\t\022\025\n\rvHiveMetadata\030\017 "
  "\001(\014\"\035\n\nHelloReply\022\017\n\007message\030\001 \001(\t2I\n\007Gr"
  "eeter\022>\n\010SayHello\022\030.helloworld.HelloRequ"
  "est\032\026.helloworld.HelloReply\"\000B;Z9github."
  "com/vhive-serverless/vSwarm-proto/proto/"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_helloworld_2eproto = {
  false, false, descriptor_table_protodef_helloworld_2eproto, "helloworld.proto", 258,
...
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  vhivemetadata_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_vhivemetadata().empty()) {
    vhivemetadata_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_vhivemetadata(),
      GetArena());
  }
...
void HelloRequest::SharedDtor() {
  ...
  vhivemetadata_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 122)) {
          auto str = _internal_mutable_vhivemetadata();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* HelloRequest::_InternalSerialize(
  ...
  // bytes vHiveMetadata = 15;
  if (this->vhivemetadata().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        15, this->_internal_vhivemetadata(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:helloworld.HelloRequest)
  ...
  if (from.vhivemetadata().size() > 0) {
    _internal_set_vhivemetadata(from._internal_vhivemetadata());
  }
}
...
void HelloRequest::InternalSwap(HelloRequest* other) {
  ...
  vhivemetadata_.Swap(&other->vhivemetadata_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
